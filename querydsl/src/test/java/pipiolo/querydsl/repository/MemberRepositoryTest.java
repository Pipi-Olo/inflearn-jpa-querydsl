...
class MemberRepositoryTest {
    ...
    @Test
    void searchTest_BooleanExpression() {
        Team teamA = new Team("teamA");
        Team teamB = new Team("teamB");
    ...
    void querydslPredicateExecutorTest() {
        ...
        // 스프링에서 제공하는 findAll() 메소드에 바로 querydsl 조건문을 넣을 수 있다.
        // 단점
        // 1. 하지만 레프트 조인이 불가능하다. (묵시적 조인은 가능하지만.. ) -> 쓸 만한 기능이 아니다.
        // 2. 서비스 계층이 querydsl 에 의존해야 한다. 리포지토리 계층의 의마가 없어짐
